        ...
        <div>
            <div>
                <div className='inline-block'>
                    ...
                    <button onClick={(ev) => {
                        fiddler.emit('set_scoring_mode', [false, true]);
                    }}>Turn off scoring mode</button>
...
function ReactGoban<GobanClass extends GobanCore>(ctor: { new(x: GobanCanvasConfig): GobanClass }, props: ReactGobanProps): JSX.Element {
    ...
    React.useEffect(() => {
        ...
        fiddler.on('set_scoring_mode', (parameters: [boolean, boolean]) => {
            goban.setScoringMode(...parameters);
        });
